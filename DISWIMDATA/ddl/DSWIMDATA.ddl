...
FROM DSWIMDATASRC.BARRIER_EQUIP_INVENTORY BEI
...
LEFT OUTER JOIN 
	...
	FROM 
		...
		FROM DSWIMDATASRC.BARRIER_EQUIP_TEST B
		LEFT OUTER JOIN DSWIMDATASRC.R_PRIORITY P ON B.SEVERITY_ID = P.R_PRIORITY_ID) 
	AS TR
